...
import com.example.myapplication.layout.example.CustomDialog;
import com.example.myapplication.layout.example.Dialog;
...
public class LayoutExample extends AppCompatActivity implements CustomDialog.customDialogListener,
    ...
    public void openDate(){
        com.example.myapplication.layout.example.DatePicker datePicker=new com.example.myapplication.layout.example.DatePicker();
